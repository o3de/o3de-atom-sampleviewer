...
function Process(context)
    ...
    if hasPerPixelDepth or hasPerPixelClip then
        ...
        TrySetShaderEnabledWithFallback(context, "visibility_customZ", "visibility", enableShadowPass)

        TrySetShaderEnabled(context, "deferred", enableMainPass)
    else
        TrySetShaderEnabled(context, "depth", enableDepthPass)
        TrySetShaderEnabled(context, "shadow", enableShadowPass)
        TrySetShaderEnabled(context, "visibility", enableMainPass)
