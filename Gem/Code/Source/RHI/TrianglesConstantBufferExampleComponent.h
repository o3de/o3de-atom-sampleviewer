...
namespace AtomSampleViewer
{
    ...
    private:
        ...
        AZ::RHI::Ptr<AZ::RHI::DeviceBufferPool> m_constantBufferPool;

        AZ::RHI::Ptr<AZ::RHI::DeviceBuffer> m_constantBuffer;

        AZ::RHI::Ptr<AZ::RHI::DeviceBufferView> m_constantBufferView;
