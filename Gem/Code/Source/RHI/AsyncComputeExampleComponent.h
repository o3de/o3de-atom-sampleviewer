...
namespace AtomSampleViewer
{
    ...
    protected:
        ...
        AZ::RHI::Ptr<AZ::RHI::DeviceBufferPool> m_quadBufferPool;
        AZ::RHI::Ptr<AZ::RHI::DeviceBuffer> m_quadInputAssemblyBuffer;
        AZ::RHI::DeviceIndexBufferView m_quadIndexBufferView;
        AZStd::array<AZStd::vector<AZ::RHI::DeviceStreamBufferView>, NumScopes> m_quadStreamBufferViews;

        // Terrain related variables
        AZStd::array<AZ::RHI::ConstPtr<AZ::RHI::DevicePipelineState>, NumScopes> m_terrainPipelineStates;

        // Model related variables
        AZStd::array<AZ::RPI::ModelLod::StreamBufferViewList, NumScopes> m_modelStreamBufferViews;
        AZStd::array<AZ::RHI::ConstPtr<AZ::RHI::DevicePipelineState>, NumScopes> m_modelPipelineStates;
        AZ::Data::Instance<AZ::RPI::Model> m_model;

        // Copy Texture related variables
        AZ::RHI::ConstPtr<AZ::RHI::DevicePipelineState> m_copyTexturePipelineState;

        // Luminance map related variables
        AZ::RHI::ConstPtr<AZ::RHI::DevicePipelineState> m_luminancePipelineState;
        
        // Luminance reduce related variables
        AZ::RHI::ConstPtr<AZ::RHI::DevicePipelineState> m_luminanceReducePipelineState;

        // Tonemapping related variables
        AZ::RHI::ConstPtr<AZ::RHI::DevicePipelineState> m_tonemappingPipelineState;
        ...
        AZStd::array<AZ::RHI::Ptr<AZ::RHI::DeviceImage>, NumSceneImages> m_sceneImages;
