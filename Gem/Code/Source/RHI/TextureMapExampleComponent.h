...
namespace AtomSampleViewer
{
    ...
    */
    ...
    protected:
        ...
        AZStd::array< AZ::RHI::Ptr<AZ::RHI::DeviceBuffer>, s_numOfTargets + 1> m_positionBuffer;
        AZStd::array< AZ::RHI::Ptr<AZ::RHI::DeviceBuffer>, s_numOfTargets + 1> m_uvBuffer;
        AZStd::array< AZ::RHI::Ptr<AZ::RHI::DeviceBuffer>, s_numOfTargets + 1> m_indexBuffer;
        AZStd::array<BufferViewData, s_numOfTargets + 1> m_bufferViews;

        // ---------------------------------------
        // Pipeline state, SRG, shader input index
        // ---------------------------------------
        AZStd::array<AZ::RHI::ConstPtr<AZ::RHI::DevicePipelineState>, s_numOfTargets> m_targetPipelineStates;
        ...
        AZStd::array<AZ::RHI::ConstPtr<AZ::RHI::DevicePipelineState>, s_numOfTargets> m_screenPipelineStates;
