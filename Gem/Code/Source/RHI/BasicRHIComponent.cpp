...
namespace AtomSampleViewer
{
    ...
    void BasicRHIComponent::CreateImage3dData(AZStd::vector<uint8_t>& data, AZ::RHI::ImageSubresourceLayout& layout, AZ::RHI::Format& format, AZStd::vector<const char*>&& imageAssetPaths)
    {
        ...
        {
            [[maybe unused]] const bool compatibleFormat = imageDescriptors[0].m_format == imageDescriptors[i].m_format;
            [[maybe unused]] const bool compatibleLayout = imageSubresourceLayouts[0].m_size == imageSubresourceLayouts[i].m_size &&
