...
namespace AtomSampleViewer
{
    ...
    protected:
        ...
        // Compute Buffer
        // ----------------------------
        AZ::RHI::Ptr<AZ::RHI::DeviceBufferPool> m_computeBufferPool;
        AZ::RHI::Ptr<AZ::RHI::DeviceBuffer> m_computeBuffer;
        AZ::RHI::Ptr<AZ::RHI::DeviceBufferView> m_computeBufferView;
        ...
        // Dispatch pipeline
        AZ::RHI::ConstPtr<AZ::RHI::DevicePipelineState> m_dispatchPipelineState;
