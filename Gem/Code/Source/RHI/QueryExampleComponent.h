...
namespace AtomSampleViewer
{
    ...
    */
    ...
    protected:
        ...
        AZ::RHI::DeviceStreamBufferView m_quadStreamBufferView;
        ...
        AZ::RHI::ConstPtr<AZ::RHI::DevicePipelineState> m_quadPipelineState;
        AZ::RHI::ConstPtr<AZ::RHI::DevicePipelineState> m_boudingBoxPipelineState;

        AZ::RHI::Ptr<AZ::RHI::DeviceQueryPool> m_occlusionQueryPool;
        AZ::RHI::Ptr<AZ::RHI::DeviceQueryPool> m_timeStampQueryPool;
        AZ::RHI::Ptr<AZ::RHI::DeviceQueryPool> m_statisticsQueryPool;

        struct QueryEntry
        {
            AZ::RHI::Ptr<AZ::RHI::DeviceQuery> m_query;
        ...
        AZ::RHI::Ptr<AZ::RHI::DeviceBufferPool> m_predicationBufferPool;
        AZ::RHI::Ptr<AZ::RHI::DeviceBuffer> m_predicationBuffer;
